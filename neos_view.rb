class NeosView
  ...
  def display_info(date)
    ...
    puts "On #{formatted_date(date)}, there were #{@total_number_of_astroids} objects that almost collided with the earth."
    puts "The largest of these was #{@biggest_astroid} ft. in diameter."
